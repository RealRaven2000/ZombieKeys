...
/* 
  ...
  ZombieKeys is released under LPG3
  For details, please refer to license.txt in the root folder of this extension

  END LICENSE BLOCK 
*/

const ADDON_NAME = "ZombieKeys";
  ...
  // 1066
	initLocale(locale) {
		...
		try {
			...
			this.Util.logException('error during deadKeys initialisation', ex);
		}
		...
		try {
			...
			this.Util.logException('error during aliveKeys initialisation', ex);
		}
